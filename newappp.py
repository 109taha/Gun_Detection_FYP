...
def database():
    ...
    sub=os.listdir("static/images")
    for frames in sub:
        with open("static/images/"+frames, "rb") as img_file:
                ...
                if len(det):
                    ...
                    for *xyxy, conf, cls in reversed(det):
                        ...
                        while count<=3:
                            ...
                            frameImageFileName = str(f'static/images/{imgNumber}.png')
